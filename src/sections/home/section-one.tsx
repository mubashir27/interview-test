      ...
      <DFlex>
        ...
        <div className="text ml-20 w-2/4">
          <div className="bg-red-light py-3 px-5 w-fit">
            <p className="text-red text-sm font-medium">-About Our Company-</p>
          </div>
          ...
          <p className="text-gray-light dark:text-light text-xl  ">
            ...
            marketing campaign meant to improve brand reputation, increase brand
            presence and optimize brand positioning thanks to our growing
            network of influencers. All these campaigns are tracked and reported
            in an honest and transparent way that answers all of your burning
            inquiries.
          </p>
